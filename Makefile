# This Makefile is for the myamc extension to perl.
#
...
#     AUTHOR => [q[Werner Suess]]
#     BUILD_REQUIRES => {  }
#     CONFIGURE_REQUIRES => {  }
#     NAME => q[myamc]
#     PREREQ_PM => {  }
#     TEST_REQUIRES => {  }
#     VERSION_FROM => q[my_auto_mail_client.pm]
...
PARENT_NAME = 
DLBASE = $(BASEEXT)
VERSION_FROM = my_auto_mail_client.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
TO_INST_PM = Makefile.pl \
	myAMCd.pl \
	my_auto_mail_client.pl \
	my_auto_mail_client.pm

PM_TO_BLIB = Makefile.pl \
	$(INST_LIB)\Makefile.pl \
	myAMCd.pl \
	$(INST_LIB)\myAMCd.pl \
	my_auto_mail_client.pl \
	$(INST_LIB)\my_auto_mail_client.pl \
	my_auto_mail_client.pm \
	$(INST_LIB)\my_auto_mail_client.pm
...
myamc.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"myamc\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "  - 'Werner Suess'" >> META_new.yml
	...
	$(NOECHO) $(ECHO) "name: myamc" >> META_new.yml
	$(NOECHO) $(ECHO) no_index: >> META_new.yml
	$(NOECHO) $(ECHO) "  directory:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - t" >> META_new.yml
	$(NOECHO) $(ECHO) "    - inc" >> META_new.yml
	$(NOECHO) $(ECHO) "requires: {{}}" >> META_new.yml
	$(NOECHO) $(ECHO) "version: '2.1'" >> META_new.yml
	-$(NOECHO) $(MV) META_new.yml $(DISTVNAME)/META.yml
	$(NOECHO) $(ECHO) Generating META.json
	$(NOECHO) $(ECHO) {{ > META_new.json
	$(NOECHO) $(ECHO) "   \"abstract\" : \"unknown\"," >> META_new.json
	$(NOECHO) $(ECHO) "   \"author\" : [" >> META_new.json
	$(NOECHO) $(ECHO) "      \"Werner Suess\"" >> META_new.json
	$(NOECHO) $(ECHO) "   ]," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   }}," >> META_new.json
	$(NOECHO) $(ECHO) "   \"name\" : \"myamc\"," >> META_new.json
	...
	$(NOECHO) $(ECHO) "   \"version\" : \"2.1\"" >> META_new.json
	$(NOECHO) $(ECHO) }} >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <AUTHOR>Werner Suess</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  ...
	  myAMCd.pl $(INST_LIB)\myAMCd.pl \
	  my_auto_mail_client.pl $(INST_LIB)\my_auto_mail_client.pl \
	  my_auto_mail_client.pm $(INST_LIB)\my_auto_mail_client.pm 
